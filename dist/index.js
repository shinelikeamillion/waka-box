module.exports = (function(e, t) {
  ...
  104: function(e, t, r) {
    ...
    function getLines(e) {
      const t = [];
      for (let r = 0; r < Math.min(e.data.languages.length, 5); r++) {
        const n = e.data.languages[r];
        const { name: i, percent: s, text: o } = n;
        const a = [
          i.length > 14 ? `${i.substring(0, 8)}...` : i.padEnd(11),
          o
            .replace(/hrs?/g, "h")
            .replace(/mins?/g, "m")
            .padEnd(9),
    ...
    async function updateGist(e) {
      ...
      try {
        ...
        await c.gists.update({
          gist_id: o,
          files: {
            [e]: { filename: `Weekly development breakdown`, content: r }
          }
        });
      } catch (e) {
  ...
  215: function(e) {
    e.exports = {
      _args: [["@octokit/rest@16.36.0", "/Users/lilsean/waka-box"]],
  ...
  361: function(e) {
    e.exports = {
      _args: [["axios@0.19.0", "/Users/lilsean/waka-box"]],
      _from: "axios@0.19.0",
      _id: "axios@0.19.0",
      _inBundle: false,
      _integrity:
